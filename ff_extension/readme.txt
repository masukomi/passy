...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\passwordhash on
     Windows, /home/user/dev/passwordhash on Linux) in a file named
     passwordhash@greg.stoll and copy that file to
